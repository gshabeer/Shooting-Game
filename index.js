window.addEventListener("load", () => {
  let boomSound = new Audio("sound/sound.wav");
  ...
  const resetHighScoreSec = document.querySelector(
    ".reset_high_score .confirm"
  );
  ...
  function animate(timestamp) {
    ...
    if (timeToNextRaven > ravenInterval) {
      ...
      ravens.push(new Enemy(enemyWidth, enemyHeight, enemyImgSrc));
      timeToNextRaven = 0;
